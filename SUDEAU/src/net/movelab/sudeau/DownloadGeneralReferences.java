 ...
 *
 */
public class DownloadGeneralReferences extends Service {

    private static String TAG = "DownloadGeneralReferences";
    ...
    public void onStart(Intent intent, int startId) {
        ...
        Util.logInfo(context, TAG, "on start");
            ...
            if (!downloading) {
                ...
                Thread refDownloadThread = new Thread(null, doRefDownloading,
                        "downloadrRefMedia");
                refDownloadThread.start();


        }
    };

    private Runnable doRefDownloading = new Runnable() {
        public void run() {
            tryDownload();
        }
    };
